          ...
          <div className="flex items-center gap-2">
            <nav className="hidden sm:flex items-center gap-2">
              <a
                ...
                className="inline-flex items-center rounded-md border border-white/20 hover:border-white/40 px-4 py-2 text-sm font-medium text-white/90 transition"
              >
                {t('hero.ctaWaitlist')}
              </a>
              <a
                href="#lend"
                onClick={handleScroll('lend')}
                className="inline-flex items-center rounded-md border border-white/20 hover:border-white/40 px-4 py-2 text-sm font-medium text-white/90 transition"
              >
                {t('hero.ctaLend')}
              </a>
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              ...
              <a
                href="#lend"
                onClick={handleScroll('lend')}
                className="inline-flex items-center rounded-lg border border-white/20 px-6 py-3 text-base font-semibold text-white/90 shadow-lg shadow-black/20 transition hover:border-white/40 hover:text-white"
              >
                {t('hero.ctaLend')}
              </a>
            </div>
