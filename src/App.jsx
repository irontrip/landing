        ...
        <div className="mx-auto max-w-7xl px-6 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group relative rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/40 ring-1 ring-black/10 transition hover:bg-white/[0.07] flex flex-col">
              ...
              <div className="mt-4">
                <a id="waitlist" href="#" className="inline-flex items-center rounded-lg border border-white/20 hover:border-white/40 px-5 py-2.5 text-sm font-medium text-white/90 backdrop-blur transition">
                  {t('hero.ctaWaitlist')}
                </a>
              </div>
